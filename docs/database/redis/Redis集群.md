...
# redis实例的声明 IP
replica-announce-ip 192.168.201.99
```
...
sed -i '1a replica-announce-ip 192.168.201.99' 7001/redis.conf
sed -i '1a replica-announce-ip 192.168.201.99' 7002/redis.conf
sed -i '1a replica-announce-ip 192.168.201.99' 7003/redis.conf
...
port 27001
sentinel announce-ip 192.168.201.99
sentinel monitor mymaster 192.168.201.99 7001 2
sentinel down-after-milliseconds mymaster 5000
sentinel failover-timeout mymaster 60000
dir "/usr/local/redis/redis-sentinel/s1"
...
redis-cli --cluster create --cluster-replicas 1 192.168.201.99:7001 192.168.201.99:7002 192.168.201.99:7003 192.168.201.99:8001 192.168.201.99:8002 192.168.201.99:8003
```
